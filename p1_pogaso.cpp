...
const bool P = false; // toggle printear output

int main(int argc, char **argv)
{
  int numtasks, rank, next, prev, tag1 = 1, tag2 = 2, N = 100000;
  ...
  cout <<"rank "<< rank << " SEND first/last: " << sbuf[0] <<", "<< sbuf[N-1] << endl;
...
/*----------------------------------------------------*/
  ...
  cout <<"rank "<< rank << " PREV first/last: " << rbuf_prev[0] <<", "<< rbuf_prev[N-1] << endl;
  cout <<"rank "<< rank << " NEXT first/last: " << rbuf_next[0] <<", "<< rbuf_next[N-1] << endl;
